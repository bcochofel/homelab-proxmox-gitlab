...
| Name | Type |
|------|------|
| [proxmox_vm_qemu.vms](https://registry.terraform.io/providers/Telmate/proxmox/3.0.1-rc4/docs/resources/vm_qemu) | resource |
...
| <a name="input_default_cipassword"></a> [default\_cipassword](#input\_default\_cipassword) | Override the default cloud-init password | `string` | n/a | yes |
| <a name="input_default_cisshkeys"></a> [default\_cisshkeys](#input\_default\_cisshkeys) | Newline delimited list of SSH public keys to add to authorized keys file for the<br/>cloud-init user. | `string` | n/a | yes |
| <a name="input_default_ciuser"></a> [default\_ciuser](#input\_default\_ciuser) | Override the default cloud-init user | `string` | n/a | yes |
| <a name="input_default_clone"></a> [default\_clone](#input\_default\_clone) | The base VM from which to clone to create the new VM. | `string` | `"ubuntu-24.04-template"` | no |
...
| <a name="input_default_desc"></a> [default\_desc](#input\_default\_desc) | The description of the VM. | `string` | `"Gitlab Setup"` | no |
...
| <a name="input_default_disk_size"></a> [default\_disk\_size](#input\_default\_disk\_size) | The size of the created disk, format must match the regex \d+[GMK] | `string` | `"50G"` | no |
...
| <a name="input_default_nameserver"></a> [default\_nameserver](#input\_default\_nameserver) | Sets default DNS server for guest. | `string` | `"192.168.68.5"` | no |
...
| <a name="input_default_tags"></a> [default\_tags](#input\_default\_tags) | Tags of the VM. | `string` | `"gitlab;terraform"` | no |
...
| <a name="output_vms_ips"></a> [vms\_ips](#output\_vms\_ips) | n/a |
<!-- END_TF_DOCS -->
